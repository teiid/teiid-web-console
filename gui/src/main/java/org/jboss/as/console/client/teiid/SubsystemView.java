...
public class SubsystemView extends SuspendableViewImpl implements
		SubsystemPresenter.MyView {
	...
	@Inject
	public SubsystemView(ResourceDescriptionRegistry descriptionRegistry,
	...
	public Widget createWidget() {
		...
		DefaultTabLayoutPanel layout = new DefaultTabLayoutPanel(40,
				Style.Unit.PX);
	...
	@Override
	public void setLogHandlerStatus(String context, String name,
